<?php
// Esta clase es para los registros de los usuarios (visitantes)
...
$sql = "INSERT INTO usuarios 
        (nombreUsuario, apellidoUsuario, emailUsuario, telUsuario, passUsuario, tipoUsuario, created_at, updated_at) 
        VALUES 
